...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-1.5 w-full grow overflow-hidden rounded-full bg-zinc-900 dark:bg-zinc-50/20">
      <SliderPrimitive.Range className="absolute h-full bg-green-400 dark:bg-zinc-50" />
