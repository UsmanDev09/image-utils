...
import { formatFileSize } from '@/app/utils/compression-algorithm/imageProcessing';
import { downloadImage } from '@/app/utils/compression-algorithm/download';
import { CompressedImageFile } from '@/app/page';
