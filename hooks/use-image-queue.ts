...
import type { ImageFile, OutputType, CompressionOptions } from '../app/types';
import { decode,encode, getFileType } from '@/app/utils/compression-algorithm/imageProcessing';
